(function () {
  ...
  function attachTooltips() {
    ...
    if (!style) {
      ...
      style.id = "gt-styles";
      style.textContent = [
        ".gt-tooltip{width:380px;line-height:1;color:#000;font-size:0.9rem;border-radius:0.5rem;}",
        ...
        '.tippy-box[data-theme~="light"] .tippy-content{padding:10px 14px;font-size:0.9rem; line-height:1;}',
        ".gt-tabs{display:flex;border-bottom:1px solid #ddd;margin-bottom:8px;}",
        ".gt-tab{flex:1;padding:4px 8px;border:none;background:none;cursor:pointer;font-size:0.9rem;color:#888;border-bottom:2px solid transparent;margin-bottom:-1px;}",
